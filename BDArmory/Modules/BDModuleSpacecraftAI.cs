...
{
    public class BDModuleSpacecraftAI : BDGenericAIBase, IBDAIControl
    {
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_DefaultAltitude"),//Default Alt.
            UI_FloatRange(minValue = 500f, maxValue = 1000000f, stepIncrement = 500f, scene = UI_Scene.All)]
        public float defaultAltitude = 100000;

        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_MinAltitude"),//Min Altitude
            UI_FloatRange(minValue = 150f, maxValue = 1000000f, stepIncrement = 500f, scene = UI_Scene.All)]
        public float minAltitude = 70000f;

        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_SteerFactor"),//Steer Factor
            UI_FloatRange(minValue = 0.1f, maxValue = 100f, stepIncrement = .1f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_SteerKi"),//Steer Ki
            UI_FloatRange(minValue = 0.01f, maxValue = 10f, stepIncrement = 0.01f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_SteerDamping"),//Steer Damping
            UI_FloatRange(minValue = 1f, maxValue = 100f, stepIncrement = 0.5f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_TakeOffSpeed"),//TakeOff Speed
            UI_FloatRange(minValue = 10f, maxValue = 1000f, stepIncrement = 10f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_MinSpeed"),//MinCombatSpeed
            UI_FloatRange(minValue = 20f, maxValue = 5000, stepIncrement = 50f, scene = UI_Scene.All)]
        ...
        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_maxAllowedAoA"),//Max AoA
            UI_FloatRange(minValue = 0f, maxValue = 180f, stepIncrement = 5f, scene = UI_Scene.All)]
        public float maxAllowedAoA = 180;
        float maxAllowedCosAoA;
        float lastAllowedAoA;

        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_Orbit", advancedTweakable = false),//Orbit 
            UI_Toggle(enabledText = "#LOC_BDArmory_Orbit_enabledText", disabledText = "#LOC_BDArmory_Orbit_disabledText", scene = UI_Scene.All),]//Retrograde (CW)--Standard (CCW)
        public bool ClockwiseOrbit = false;

        [KSPField(isPersistant = true, guiActive = true, guiActiveEditor = true, guiName = "#LOC_BDArmory_UnclampTuning", advancedTweakable = false),//High orbit toggle
            UI_Toggle(enabledText = "#LOC_BDArmory_UnclampTuning_enabledText", disabledText = "#LOC_BDArmory_UnclampTuning_disabledText", scene = UI_Scene.All),]//Low--High
        public bool UpToEleven = false;
        bool toEleven = false;

        Dictionary<string, float> altMaxValues = new Dictionary<string, float>
        {
            { nameof(defaultAltitude), 1000000000f },
            { nameof(minAltitude), 1000000000f },
            { nameof(steerMult), 100f },
            { nameof(steerKiAdjust), 10f },
            { nameof(steerDamping), 100f },
            { nameof(maxSpeed), 15000f },
            { nameof(takeOffSpeed), 2000f },
            { nameof(minSpeed), 1000f },
            { nameof(idleSpeed), 15000f },
            { nameof(maxAllowedGForce), 100f },
